...
import platform
from ibm_cloud_db2.version import __version__

HEADER_NAME_USER_AGENT = 'User-Agent'
SDK_NAME = 'cloud-db2-python-sdk'
...
def get_sdk_headers(service_name, service_version, operation_id):
    ...
    cloud-db2-python-sdk/0.2.0 (lang=python; arch=x86_64; os=Linux; python.version=3.7.4)

    In the example above, the analytics tool will parse the user-agent header and
    use the following properties:
    "cloud-db2-python-sdk" - the name of your sdk
    "0.2.0"- the version of your sdk
